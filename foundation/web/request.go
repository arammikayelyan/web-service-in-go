...
func init() {
	...
	// Provide one or more arguments for additional support locales.
...
// The body decoded into the provided value.
//
...
func Decode(r *http.Request, val interface{}) error {
	...
	// at this point we've got 'val' data decoded into a Go struct
	...
	if err := validate.Struct(val); err != nil {
		...
		// lang controls the language of the error message. You could look at the
